...
function oc_db_schema() {
	...
	$tables[] = [
		'name' => 'so_homeslider_description',
		'field' => [
			[
				'name' => 'homeslider_id',
				'type' => 'int(11)',
	...
	$tables[] = [
		'name' => 'so_countdown_popup_description',
		'field' => [
			[
				'name' => 'language_id',
				'type' => 'int(11)'
